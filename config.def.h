...
static const char *mutevol[] = { "amixer", "-D",   "pipewire","sset","Master", "toggle",  NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_q,      quit,           {999} },
...
static Button buttons[] = {
	...
	{ ClkClientWin,         MODKEY,         Button3,        resizemouse,    {0} },//Why was this bound to the mouse wheel??
